...
postgres & \begin{tabular}[c]{c} Haidn \\Siegel\end{tabular} & \begin{tabular}[c]{c}5\\ 5\end{tabular}    \\ \hline 
...
Documentation & \begin{tabular}[c]{c} Haidn \\Siegel\end{tabular} & \begin{tabular}[c]{c}1\\ 2\end{tabular}    \\ \hline 

\hline \hline
Total & \begin{tabular}[c]{c}Haidn\\ Siegel\end{tabular} & \begin{tabular}[c]{c}11\\10.5\end{tabular}   \\ \hline 
\textbf{Total Team} & & \textbf{21.5 hours}  \\ \hline 
\end{tabular}
\end{table}
\FloatBarrier
...
%\todo{Autobackup - needs to be tested:: and then documented.}
