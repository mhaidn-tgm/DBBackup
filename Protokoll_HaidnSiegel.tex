...
\hline \hline
Total & \begin{tabular}[c]{c}Haidn\\ Siegel\end{tabular} & \begin{tabular}[c]{c}14.5\\14\end{tabular}   \\ \hline 
\textbf{Total Team} & & \textbf{28.5 hours}  \\ \hline 
\end{tabular}
\end{table}
\FloatBarrier
...
%http://www.farces.com/wikis/naked-server/mysql/automysqlbackup/
\begin{figure}[!h]
	\begin{center}
